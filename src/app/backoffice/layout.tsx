      ...
      <div className="mx-auto flex w-full max-w-7xl flex-1 flex-col px-4 py-8 md:flex-row md:gap-8 sm:px-6">
        ...
        <aside className="w-full shrink-0 md:w-60">
          <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm flex flex-col gap-1.5">
            ...
            <SidebarLink href="/backoffice/operations" label="Operations">
              <svg
                className="h-5 w-5"
                fill="none"
                viewBox="0 0 24 24"
            ...
            <SidebarLink href="/backoffice/sales" label="Sales Overview">
              <svg
                className="h-5 w-5"
                fill="none"
                viewBox="0 0 24 24"
            ...
            <SidebarLink href="/backoffice/inventory" label="Stock Inventory">
              <svg
                className="h-5 w-5"
                fill="none"
                viewBox="0 0 24 24"
            ...
            <SidebarLink href="/backoffice/attendance" label="Attendance Registry">
              <svg
                className="h-5 w-5"
                fill="none"
                viewBox="0 0 24 24"
